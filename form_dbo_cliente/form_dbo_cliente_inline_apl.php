<?php
//
class form_dbo_cliente_inline_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_dbo_cliente_inline_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_dbo_cliente_inline']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_dbo_cliente_inline']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_dbo_cliente_inline'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_dbo_cliente_inline']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_dbo_cliente_inline']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_dbo_cliente_inline') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_dbo_cliente_inline']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " dbo.cliente";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_dbo_cliente_inline")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_dbo_cliente_inline']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_dbo_cliente_inline'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_dbo_cliente_inline']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_dbo_cliente_inline'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_dbo_cliente_inline'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dados_form'];
          if (!isset($this->logistica_)){$this->logistica_ = $this->nmgp_dados_form['logistica_'];} 
          if (!isset($this->pimportado_)){$this->pimportado_ = $this->nmgp_dados_form['pimportado_'];} 
          if (!isset($this->vendedor01_)){$this->vendedor01_ = $this->nmgp_dados_form['vendedor01_'];} 
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_dbo_cliente_inline", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_dbo_cliente/form_dbo_cliente_inline_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_dbo_cliente_inline_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_dbo_cliente_inline_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_dbo_cliente_inline_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_dbo_cliente/form_dbo_cliente_inline_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_dbo_cliente_inline_erro.class.php"); 
      }
      $this->Erro      = new form_dbo_cliente_inline_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['sc_max_reg']) == "all")
      {
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao']))
         { 
             if ($this->cd_cliente_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_dbo_cliente_inline']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_dbo_cliente_inline']) || !is_array($this->NM_ajax_info['errList']['geral_form_dbo_cliente_inline']))
              {
                  $this->NM_ajax_info['errList']['geral_form_dbo_cliente_inline'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_dbo_cliente_inline'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_qtdeliberada_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->qtdeliberada_, 38, 15, -0, 1.0E+53, "N") == false)  
              { 
    ...
    function ValidateField_icms_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->icms_, 38, 15, -0, 1.0E+53, "N") == false)  
              { 
                  $Campos_Crit .= "Icms; " ; 
                  if (!isset($Campos_Erros['icms_']))
                  {
    ...
    function ValidateField_limitecredito_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->limitecredito_, 38, 15, -0, 1.0E+53, "N") == false)  
              { 
    ...
    function ValidateField_comissao_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->comissao_, 38, 15, -0, 1.0E+53, "N") == false)  
              { 
    ...
    function ValidateField_segmento_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->segmento_, 38, 15, -0, 1.0E+53, "N") == false)  
              { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   {
          $this->ajax_return_values_cd_cliente_();
          $this->ajax_return_values_razaosocial_();
          $this->ajax_return_values_nomefantasia_();
          $this->ajax_return_values_cgc_();
          $this->ajax_return_values_inscricao_();
          $this->ajax_return_values_endereco_();
          $this->ajax_return_values_cidade_();
          $this->ajax_return_values_estado_();
          $this->ajax_return_values_bairro_();
          $this->ajax_return_values_cep_();
          $this->ajax_return_values_email_();
          $this->ajax_return_values_fone_();
          $this->ajax_return_values_fone1_();
          $this->ajax_return_values_fax_();
          $this->ajax_return_values_contato_();
          $this->ajax_return_values_enderecocobranca_();
          $this->ajax_return_values_cidadecobranca_();
          $this->ajax_return_values_bairrocobranca_();
          $this->ajax_return_values_estadocobranca_();
          $this->ajax_return_values_cepcobranca_();
          $this->ajax_return_values_fonecobranca_();
          $this->ajax_return_values_faxcobranca_();
          $this->ajax_return_values_contatocobranca_();
          $this->ajax_return_values_cgcentrega_();
          $this->ajax_return_values_inscricaoentrega_();
          $this->ajax_return_values_enderecoentrega_();
          $this->ajax_return_values_cidadeentrega_();
          $this->ajax_return_values_bairroentrega_();
          $this->ajax_return_values_estadoentrega_();
          $this->ajax_return_values_cepentrega_();
          $this->ajax_return_values_foneentrega_();
          $this->ajax_return_values_contatoentrega_();
          $this->ajax_return_values_contatoexpedicao_();
          $this->ajax_return_values_foneexpedicao_();
          $this->ajax_return_values_datacadastro_();
          $this->ajax_return_values_obs_();
          $this->ajax_return_values_tipo_();
          $this->ajax_return_values_consumidor_();
          $this->ajax_return_values_licensa_();
          $this->ajax_return_values_venctolicensa_();
          $this->ajax_return_values_licensa1_();
          $this->ajax_return_values_venctolicensa1_();
          $this->ajax_return_values_qtdeliberada_();
          $this->ajax_return_values_licensa2_();
          $this->ajax_return_values_venctolicensa2_();
          $this->ajax_return_values_icms_();
          $this->ajax_return_values_suframa_();
          $this->ajax_return_values_limitecredito_();
          $this->ajax_return_values_vendedor_();
          $this->ajax_return_values_restricao_();
          $this->ajax_return_values_comissao_();
          $this->ajax_return_values_transportadora_();
          $this->ajax_return_values_coleta_();
          $this->ajax_return_values_segmento_();
          $this->ajax_return_values_dataalteracao_();
          $this->ajax_return_values_usuario_();
          $this->ajax_return_values_requisitos_();
          $this->ajax_return_values_banco_();
          $this->ajax_return_values_emailcobranca_();
          $this->ajax_return_values_emailtecnico_();
          $this->ajax_return_values_midia_();
          $this->ajax_return_values_seg_();
          $this->ajax_return_values_ter_();
          $this->ajax_return_values_qua_();
          $this->ajax_return_values_qui_();
          $this->ajax_return_values_sex_();
          $this->ajax_return_values_certificado_();
          $this->ajax_return_values_emailnfe_();
          $this->ajax_return_values_fundacao_();
          $this->ajax_return_values_site_();
          $this->ajax_return_values_financeiro_();
          $this->ajax_return_values_numero_();
          $this->ajax_return_values_complemento_();
          $this->ajax_return_values_razaosocialentrega_();
          $this->ajax_return_values_entrega_();
          $this->ajax_return_values_contatotecnico_();
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              $this->NM_ajax_info['clearUpload']      = 'S';
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['cd_cliente_']['keyVal'] = form_dbo_cliente_inline_pack_protect_string($this->nmgp_dados_form['cd_cliente_']);
          }
   } // ajax_return_values

          //----- cd_cliente_
   function ajax_return_values_cd_cliente_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cd_cliente_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cd_cliente_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cd_cliente_'] = array(
                       'row'    => '',
               'type'    => 'label',
          ...
          //----- razaosocial_
   function ajax_return_values_razaosocial_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("razaosocial_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->razaosocial_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['razaosocial_'] = array(
                       'row'    => '',
               'type'    => 'text',
          ...
          //----- nomefantasia_
   function ajax_return_values_nomefantasia_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nomefantasia_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nomefantasia_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nomefantasia_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- cgc_
   function ajax_return_values_cgc_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cgc_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cgc_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cgc_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- inscricao_
   function ajax_return_values_inscricao_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("inscricao_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->inscricao_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['inscricao_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- endereco_
   function ajax_return_values_endereco_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("endereco_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->endereco_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['endereco_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- cidade_
   function ajax_return_values_cidade_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cidade_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cidade_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cidade_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- estado_
   function ajax_return_values_estado_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("estado_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->estado_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['estado_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- bairro_
   function ajax_return_values_bairro_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("bairro_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->bairro_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['bairro_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- cep_
   function ajax_return_values_cep_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cep_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cep_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cep_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- email_
   function ajax_return_values_email_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("email_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->email_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['email_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fone_
   function ajax_return_values_fone_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fone_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fone_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fone_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fone1_
   function ajax_return_values_fone1_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fone1_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fone1_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fone1_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fax_
   function ajax_return_values_fax_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fax_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fax_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fax_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- contato_
   function ajax_return_values_contato_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("contato_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->contato_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['contato_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- enderecocobranca_
   function ajax_return_values_enderecocobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("enderecocobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->enderecocobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['enderecocobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- cidadecobranca_
   function ajax_return_values_cidadecobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cidadecobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cidadecobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cidadecobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- bairrocobranca_
   function ajax_return_values_bairrocobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("bairrocobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->bairrocobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['bairrocobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- estadocobranca_
   function ajax_return_values_estadocobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("estadocobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->estadocobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['estadocobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- cepcobranca_
   function ajax_return_values_cepcobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cepcobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cepcobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cepcobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fonecobranca_
   function ajax_return_values_fonecobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fonecobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fonecobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fonecobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- faxcobranca_
   function ajax_return_values_faxcobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("faxcobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->faxcobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['faxcobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- contatocobranca_
   function ajax_return_values_contatocobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("contatocobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->contatocobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['contatocobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- cgcentrega_
   function ajax_return_values_cgcentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cgcentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cgcentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cgcentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- inscricaoentrega_
   function ajax_return_values_inscricaoentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("inscricaoentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->inscricaoentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['inscricaoentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- enderecoentrega_
   function ajax_return_values_enderecoentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("enderecoentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->enderecoentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['enderecoentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- cidadeentrega_
   function ajax_return_values_cidadeentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cidadeentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cidadeentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cidadeentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- bairroentrega_
   function ajax_return_values_bairroentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("bairroentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->bairroentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['bairroentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- estadoentrega_
   function ajax_return_values_estadoentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("estadoentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->estadoentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['estadoentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- cepentrega_
   function ajax_return_values_cepentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cepentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cepentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cepentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- foneentrega_
   function ajax_return_values_foneentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("foneentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->foneentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['foneentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- contatoentrega_
   function ajax_return_values_contatoentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("contatoentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->contatoentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['contatoentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- contatoexpedicao_
   function ajax_return_values_contatoexpedicao_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("contatoexpedicao_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->contatoexpedicao_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['contatoexpedicao_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- foneexpedicao_
   function ajax_return_values_foneexpedicao_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("foneexpedicao_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->foneexpedicao_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['foneexpedicao_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- datacadastro_
   function ajax_return_values_datacadastro_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("datacadastro_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->datacadastro_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['datacadastro_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->datacadastro_ . ' ' . $this->datacadastro__hora),
              );
          }
   }

          //----- obs_
   function ajax_return_values_obs_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("obs_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->obs_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['obs_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- tipo_
   function ajax_return_values_tipo_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("tipo_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->tipo_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['tipo_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- consumidor_
   function ajax_return_values_consumidor_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("consumidor_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->consumidor_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['consumidor_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- licensa_
   function ajax_return_values_licensa_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("licensa_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->licensa_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['licensa_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- venctolicensa_
   function ajax_return_values_venctolicensa_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("venctolicensa_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->venctolicensa_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['venctolicensa_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->venctolicensa_ . ' ' . $this->venctolicensa__hora),
              );
          }
   }

          //----- licensa1_
   function ajax_return_values_licensa1_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("licensa1_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->licensa1_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['licensa1_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- venctolicensa1_
   function ajax_return_values_venctolicensa1_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("venctolicensa1_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->venctolicensa1_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['venctolicensa1_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->venctolicensa1_ . ' ' . $this->venctolicensa1__hora),
              );
          }
   }

          //----- qtdeliberada_
   function ajax_return_values_qtdeliberada_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("qtdeliberada_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->qtdeliberada_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['qtdeliberada_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- licensa2_
   function ajax_return_values_licensa2_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("licensa2_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->licensa2_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['licensa2_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- venctolicensa2_
   function ajax_return_values_venctolicensa2_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("venctolicensa2_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->venctolicensa2_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['venctolicensa2_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->venctolicensa2_ . ' ' . $this->venctolicensa2__hora),
              );
          }
   }

          //----- icms_
   function ajax_return_values_icms_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("icms_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->icms_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['icms_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- suframa_
   function ajax_return_values_suframa_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("suframa_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->suframa_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['suframa_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- limitecredito_
   function ajax_return_values_limitecredito_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("limitecredito_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->limitecredito_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['limitecredito_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- vendedor_
   function ajax_return_values_vendedor_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("vendedor_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->vendedor_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['vendedor_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- restricao_
   function ajax_return_values_restricao_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("restricao_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->restricao_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['restricao_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- comissao_
   function ajax_return_values_comissao_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("comissao_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->comissao_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['comissao_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- transportadora_
   function ajax_return_values_transportadora_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("transportadora_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->transportadora_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['transportadora_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- coleta_
   function ajax_return_values_coleta_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("coleta_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->coleta_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['coleta_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- segmento_
   function ajax_return_values_segmento_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("segmento_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->segmento_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['segmento_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- dataalteracao_
   function ajax_return_values_dataalteracao_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dataalteracao_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->dataalteracao_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['dataalteracao_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->dataalteracao_ . ' ' . $this->dataalteracao__hora),
              );
          }
   }

          //----- usuario_
   function ajax_return_values_usuario_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usuario_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usuario_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['usuario_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- requisitos_
   function ajax_return_values_requisitos_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("requisitos_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->requisitos_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['requisitos_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- banco_
   function ajax_return_values_banco_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("banco_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->banco_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['banco_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- emailcobranca_
   function ajax_return_values_emailcobranca_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("emailcobranca_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->emailcobranca_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['emailcobranca_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- emailtecnico_
   function ajax_return_values_emailtecnico_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("emailtecnico_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->emailtecnico_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['emailtecnico_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- midia_
   function ajax_return_values_midia_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("midia_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->midia_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['midia_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- seg_
   function ajax_return_values_seg_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("seg_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->seg_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['seg_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- ter_
   function ajax_return_values_ter_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ter_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->ter_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['ter_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- qua_
   function ajax_return_values_qua_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("qua_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->qua_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['qua_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- qui_
   function ajax_return_values_qui_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("qui_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->qui_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['qui_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- sex_
   function ajax_return_values_sex_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("sex_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->sex_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['sex_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- certificado_
   function ajax_return_values_certificado_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("certificado_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->certificado_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['certificado_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- emailnfe_
   function ajax_return_values_emailnfe_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("emailnfe_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->emailnfe_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['emailnfe_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- fundacao_
   function ajax_return_values_fundacao_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fundacao_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fundacao_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fundacao_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->fundacao_ . ' ' . $this->fundacao__hora),
              );
          }
   }

          //----- site_
   function ajax_return_values_site_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("site_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->site_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['site_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- financeiro_
   function ajax_return_values_financeiro_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("financeiro_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->financeiro_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['financeiro_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- numero_
   function ajax_return_values_numero_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("numero_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->numero_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['numero_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- complemento_
   function ajax_return_values_complemento_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("complemento_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->complemento_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['complemento_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- razaosocialentrega_
   function ajax_return_values_razaosocialentrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("razaosocialentrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->razaosocialentrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['razaosocialentrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- entrega_
   function ajax_return_values_entrega_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("entrega_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->entrega_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['entrega_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- contatotecnico_
   function ajax_return_values_contatotecnico_($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("contatotecnico_", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->contatotecnico_);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['contatotecnico_'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->vendedor01_ = $this->vendedor01__before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['parms'] = "cd_cliente_?#?$this->cd_cliente_?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['iframe_evento'] = $this->sc_evento; 
      } 
      if (!isset($this->nmgp_opcao) || empty($this->nmgp_opcao)) 
      { 
          if (empty($this->cd_cliente_)) 
          { 
              $this->nmgp_opcao = "inicio"; 
          } 
          else 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
      ...
      { 
          ...
          $qt_geral_reg_form_dbo_cliente_inline = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total'] = $qt_geral_reg_form_dbo_cliente_inline;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->cd_cliente_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_dbo_cliente_inline = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] > $qt_geral_reg_form_dbo_cliente_inline)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] = $qt_geral_reg_form_dbo_cliente_inline; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_dbo_cliente_inline) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $aWhere[] = "Cd_cliente = '$this->cd_cliente_'"; 
              }  
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $aWhere[] = "Cd_cliente = '$this->cd_cliente_'"; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] < $qt_geral_reg_form_dbo_cliente_inline;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              $this->datacadastro_ = "";  
              $this->datacadastro__hora = "" ;  
              $this->nmgp_dados_form["datacadastro_"] = $this->datacadastro_;
              $this->obs_ = "";  
              $this->nmgp_dados_form["obs_"] = $this->obs_;
              $this->tipo_ = "";  
              $this->nmgp_dados_form["tipo_"] = $this->tipo_;
              ...
              $this->venctolicensa_ = "";  
              $this->venctolicensa__hora = "" ;  
              $this->nmgp_dados_form["venctolicensa_"] = $this->venctolicensa_;
              $this->licensa1_ = "";  
              $this->nmgp_dados_form["licensa1_"] = $this->licensa1_;
              $this->venctolicensa1_ = "";  
              $this->venctolicensa1__hora = "" ;  
              $this->nmgp_dados_form["venctolicensa1_"] = $this->venctolicensa1_;
              $this->qtdeliberada_ = "";  
              $this->nmgp_dados_form["qtdeliberada_"] = $this->qtdeliberada_;
              $this->licensa2_ = "";  
              $this->nmgp_dados_form["licensa2_"] = $this->licensa2_;
              $this->venctolicensa2_ = "";  
              $this->venctolicensa2__hora = "" ;  
              $this->nmgp_dados_form["venctolicensa2_"] = $this->venctolicensa2_;
              $this->icms_ = "";  
              $this->nmgp_dados_form["icms_"] = $this->icms_;
              $this->suframa_ = "";  
              $this->nmgp_dados_form["suframa_"] = $this->suframa_;
              ...
              $this->dataalteracao_ = "";  
              $this->dataalteracao__hora = "" ;  
              $this->nmgp_dados_form["dataalteracao_"] = $this->dataalteracao_;
              $this->usuario_ = "";  
              $this->nmgp_dados_form["usuario_"] = $this->usuario_;
              $this->requisitos_ = "";  
              $this->nmgp_dados_form["requisitos_"] = $this->requisitos_;
              ...
              $this->fundacao_ = "";  
              $this->fundacao__hora = "" ;  
              $this->nmgp_dados_form["fundacao_"] = $this->fundacao_;
              $this->site_ = "";  
              $this->nmgp_dados_form["site_"] = $this->site_;
              $this->financeiro_ = "";  
              $this->nmgp_dados_form["financeiro_"] = $this->financeiro_;
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(Cd_cliente) from " . $this->Ini->nm_tabela . " where Cd_cliente < '$this->cd_cliente_'" . $str_where_filter; 
         $rs = $this->Db->Execute("select max(Cd_cliente) from " . $this->Ini->nm_tabela . " where Cd_cliente < '$this->cd_cliente_'" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(Cd_cliente) from " . $this->Ini->nm_tabela . " where Cd_cliente < '$this->cd_cliente_'" . $str_where_filter; 
     ...
     { 
         $this->cd_cliente_ = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(Cd_cliente) from " . $this->Ini->nm_tabela . " where Cd_cliente > '$this->cd_cliente_'" . $str_where_filter; 
         $rs = $this->Db->Execute("select min(Cd_cliente) from " . $this->Ini->nm_tabela . " where Cd_cliente > '$this->cd_cliente_'" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(Cd_cliente) from " . $this->Ini->nm_tabela . " where Cd_cliente > '$this->cd_cliente_'" . $str_where_filter; 
...
//-- 
   ...
   {   
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(Cd_cliente) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select min(Cd_cliente) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(Cd_cliente) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
...
//-- 
   ...
   { 
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(Cd_cliente) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(Cd_cliente) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(Cd_cliente) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_dbo_cliente_inline_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_dbo_cliente_inline = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['total'] = $qt_geral_reg_form_dbo_cliente_inline;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_dbo_cliente_inline_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_dbo_cliente_inline_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_dbo_cliente_inline_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_cliente_inline']['masterValue']))
{
