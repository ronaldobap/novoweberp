...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_datacadastro__hora' + iSeqRow).bind('blur', function() { sc_form_dbo_cliente_datacadastro__onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_dbo_cliente_datacadastro__onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_venctolicensa__hora' + iSeqRow).bind('blur', function() { sc_form_dbo_cliente_venctolicensa__onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_dbo_cliente_venctolicensa__onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_venctolicensa1__hora' + iSeqRow).bind('blur', function() { sc_form_dbo_cliente_venctolicensa1__onblur(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_dbo_cliente_venctolicensa1__onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_venctolicensa2__hora' + iSeqRow).bind('blur', function() { sc_form_dbo_cliente_venctolicensa2__onblur(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_dbo_cliente_venctolicensa2__onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dataalteracao__hora' + iSeqRow).bind('blur', function() { sc_form_dbo_cliente_dataalteracao__onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_dbo_cliente_dataalteracao__onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fundacao__hora' + iSeqRow).bind('blur', function() { sc_form_dbo_cliente_fundacao__onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_dbo_cliente_fundacao__onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_dbo_cliente_inline_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_datacadastro_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_cliente_inline_validate_datacadastro_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#id_sc_field_venctolicensa_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_cliente_inline_validate_venctolicensa_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#id_sc_field_venctolicensa1_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_cliente_inline_validate_venctolicensa1_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#id_sc_field_venctolicensa2_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_cliente_inline_validate_venctolicensa2_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#id_sc_field_dataalteracao_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_cliente_inline_validate_dataalteracao_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#id_sc_field_fundacao_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_cliente_inline_validate_fundacao_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
